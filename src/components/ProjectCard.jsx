...
const ProjectCard = ({ title, description, technologies, link }) => {
  return (
    <div className="bg-indigo-500 p-6 rounded-xl border-1 border-solid hover:cursor-pointer border-gray-900 shadow-md transition-transform hover:scale-105 hover:shadow-xl duration-300 w-70 md:w-70 flex flex-col justify-between">
      <div>
