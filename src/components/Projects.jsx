...
const Projects = () => {
  return (
    <section className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-purple-800 mb-10">Proyectos</h1>
      ...
      <div className="flex flex-wrap justify-center gap-6">
        <div className="bg-white p-6 rounded-xl shadow-md transition-transform hover:scale-105 hover:shadow-xl duration-300 w-full sm:w-80">
          ...
          <p className="text-gray-600 mb-3">
            Página web responsiva para presentar información personal y
            profesional.
          </p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md transition-transform hover:scale-105 hover:shadow-xl duration-300 w-full sm:w-80">
          ...
          <p className="text-gray-600 mb-3">
            Aplicación para gestionar usuarios, roles y estadísticas del
            sistema.
          </p>
        ...
        <div className="bg-white p-6 rounded-xl shadow-md transition-transform hover:scale-105 hover:shadow-xl duration-300 w-full sm:w-80">
          ...
          <p className="text-gray-600 mb-3">
            App para buscar películas utilizando una API externa, con manejo de
            estados.
          </p>
          <span className="text-sm text-gray-500">
